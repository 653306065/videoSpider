...
public class OKHttpUtils implements ApplicationRunner {
    ...
    static OkHttpClient httpClient = new OkHttpClient.Builder().writeTimeout(20,TimeUnit.SECONDS).callTimeout(20,TimeUnit.SECONDS).connectTimeout(20, TimeUnit.SECONDS).readTimeout(20, TimeUnit.SECONDS).build();
    ...
    public void run(ApplicationArguments args) {
        ...
        proxyHttpClient = new OkHttpClient.Builder().proxy(proxy).writeTimeout(20,TimeUnit.SECONDS).callTimeout(20,TimeUnit.SECONDS).connectTimeout(20, TimeUnit.SECONDS).readTimeout(20, TimeUnit.SECONDS).build();
    }
}
