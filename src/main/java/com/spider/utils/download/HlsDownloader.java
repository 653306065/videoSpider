...
//        dataInputStream.close();
    ...
    public static void main(String[] args) {
        String originUrlpath = "https://dv-h.phncdn.com/hls/videos/202011/01/365874011/,1080P_4000K,720P_4000K,480P_2000K,240P_400K,_365874011.mp4.urlset/index-f1-v1-a1.m3u8?ttl=1610446316&l=0&hash=5a3550b8f9915b9a3802a64858ab98fe";
        String preUrlPath = originUrlpath.substring(0, originUrlpath.lastIndexOf("/") + 1);
        String rootPath = "C:\\videodir";
        String fileName = "";
